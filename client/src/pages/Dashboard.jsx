...
const Dashboard = () => {
  ...
  const handleCreateMeeting = ()=>{
   ...
   const handleJoinMeeting = (e)=>{
    ...
    if(!/^[a-z]{3}(?:-[a-z]{3}){2}$/i.test(cleanId)){
  ...
  return (
    <div className='flex-1 max-w-7xl mx-auto p-6 md:p-12 flex flex-col justify-center'>
      <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-center '>
        ...
        <div className='lg:col-span-7 space-y-8 '>
          <div className='space-y-3'>
            ...
            <h1 className='text-4xl sm:text-5xl text-slate-800 leading-tight font-medium'>High quality video calls <br />
              <span className='text-primary'>Built for everyone
                </span></h1>
                <p className='text-slate-700 text-base sm:text-lg max-w-xl leading-relaxed '>
                  connect,collaborate,and celebrate from anywhere with ultra-low latency video,sharing, and real-time chat.
                </p>

                <div className='flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2'>
                  <button onClick={handleCreateMeeting} disabled = {isCreating} className='bg-primary hover:bg-primary-hover text-white font-medium px-6 py-3.5 rounded-full shadow-md shadow-primary/20 flex items-center justify-center gap-2.5 transition-all cursor-pointer disabled:opacity-50'>
                  ...
                  <form onSubmit={handleJoinMeeting} className='flex-1 flex items-center gap-2'>
                    ...
                    disabled:hover:bg-slate-900 text-white font-medium px-6 py-3.5 rounded-full transition-all flex items-center justify-center cursor-pointer shadow-xs'>
                      <span>Join</span>
                      <ArrowRightIcon className=' w-4 h-4 ml-4.5'/>
        ...
        <div className='lg:col-span-5 flex fllex-col items-center justify-center space-y-4'>
          ...
          <div className='space-y-1'>
            ...
            <h2 className=' text-4xl xl:text-7xl my-4 text-slate-900 tracking-wide'>{currentTime.toLocaleTimeString([],{hour:"2-digit",minute: "2-digit"})}</h2>
            <p className='font-medium tracking-wider text-primary'>
              {currentTime.toLocaleTimeString(undefined,{weekday:"long",
                month:"short",
                day:"numeric",
                year:"numeric"
              })}
