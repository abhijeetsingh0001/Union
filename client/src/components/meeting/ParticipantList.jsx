...
const ParticipantList = ({ isOpen, onClose, localUser, localAudio, localVideo, remoteUsers, meetingHostId }) => {
  ...
  return (
    <aside className="w-full sm:w-80 h-full bg-white border-1 border-slate-200 flex flex-col z-30 shadow-2xl animate-in slide-in-from-right duration-200">
      ...
      <div className='flex-1 p-4 overflow-y-auto space-y-3'>{allParticipants.map((p) => {
        ...
        return (
          <div key={p.socketId}
            ...
            <div className='flex items-center gap-3'>
              ...
              <span className='text-sm font-medium text-slate-800 flex items-center gap-1.5'>{p.userName}
