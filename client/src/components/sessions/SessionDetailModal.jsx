...
const SessionDetailModal = ({session,onClose}) => {
  ...
  return (
    <div className='fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4'>
      <div className='bg-white rounded-3xl max-w-2xl w-full max-h-[85vh] flex flex-col shadow-2xl border border-slate-100 overflow-100 overflow-hodden animate-in fade-in zoom-in duration-150'>
        ...
        <div className='p-6 border-b border-slate-100 flex items-center justify-between'>
          <div>
            ...
            <h2 className='text-2xl font-medium text-slate-900 mt-1'>{session.title || "Meeting Detail"}</h2>
